...
from utils.degradation_process import Degradation
from utils.advective_processes import AdvectiveProcess
from utils.diffusion_process_non_ion import Diffusion, MTC
