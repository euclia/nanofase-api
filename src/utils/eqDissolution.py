...
def eqDissolution(ENM,FWpH,SWpH,GWpH1,GWpH2,GWpH3,GWpH4,presence):
	...
	if ENM == 'Ag':
		contents = sio.loadmat('../data/chemFate_data/Ag_eq_dis.mat')
	elif ENM == 'CuO':
		contents = sio.loadmat('C:/Users/jason/OneDrive/Documents/GitHub/nanofase-api/src/data/chemFate_data/CuO_eq_dis.mat')
	elif ENM == 'nZVI':
		contents = sio.loadmat('../data/chemFate_data/nZVI_eq_dis.mat')
	elif ENM == 'TiO2':
		contents = sio.loadmat('../data/chemFate_data/TiO2_eq_dis.mat')
	elif ENM == 'ZnO':
		contents = sio.loadmat('../data/chemFate_data/ZnO_eq_dis.mat')
	elif ENM == 'CeO2':
		contents = sio.loadmat('../data/chemFate_data/CeO2_eq_dis.mat')
	elif ENM == 'SiO2':
		contents = sio.loadmat('../data/chemFate_data/SiO2_eq_dis.mat')
